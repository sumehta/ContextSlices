...
$pictures = Array('images/nyc.jpg','images/PebbleBeach8.jpg','images/vt.jpg');
shuffle($pictures);
$pictureName = $pictures[0];
$pictureID = substr($pictureName, 7, -4); 
